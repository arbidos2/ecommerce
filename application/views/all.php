...
<body>
	<div class="container">
		...
		<div class="main">
			<div class="title">
				<div id="selected_category"><h3>Show All (page<?= "<p class='title_number'>" . $current_page . "</p>"; ?>)</h3></div>
				<div id="category_nav">
					<div id="page">
						<a href="/products/pagination/1">first</a> | 
						<a href="/products/pagination/
							<?php
							$items_per_row = 5;
							$num_rows = 3;
...
<?php
				if ($num_pages == 1){
					...
					for ($i = $current_page + 1; $i < $num_pages; $i++){
						...
						echo "
					 | <a href='/products/pagination/" . $num_pages . "'>NEXT</a>";
				} else if ($current_page == 1 && $num_pages > 10){
						echo "
					PREV | 
					<p class='current_number'>" . $current_page . " </p>";
					...
					for ($i = $current_page + 1; $i <= $num_pages; $i++){
						...
						echo " | <a href='/products/pagination/" . $num_pages . "'>NEXT</a>";					
				} else {
					...
					echo " | <a href='/products/pagination/" . $next . "'>NEXT</a>";					
				}
				?>
			</div> 
